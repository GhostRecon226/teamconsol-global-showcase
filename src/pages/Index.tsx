    ...
    <div className="min-h-screen bg-background">
            ...
            <Sheet open={open} onOpenChange={setOpen}>
              ...
              <SheetContent side="right" className="w-72">
                <nav className="flex flex-col gap-6 mt-10">
                  {navLinks.map(({ href, label }) => (
                    <a key={href} href={href} onClick={() => setOpen(false)} className="text-lg font-medium text-foreground hover:text-primary transition-colors">{label}</a>
                  ))}
                  <a href="#contact" onClick={() => setOpen(false)} className="bg-primary text-primary-foreground px-5 py-2.5 rounded-md text-sm font-semibold text-center hover:opacity-90 transition-opacity">
                    Get a Quote
                  </a>
                </nav>
              </SheetContent>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            <AnimatedSection>
              ...
              <a href="#contact" className="inline-flex items-center gap-3 bg-foreground text-background px-6 py-3 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity">
                Get a Quote
              ...
              <StaggerItem key={title}>
                <div className="group bg-secondary rounded-xl overflow-hidden">
                  <div className="overflow-hidden rounded-xl m-2">
                    <img src={img} alt={title} className="w-full h-52 md:h-64 object-cover rounded-xl group-hover:scale-105 transition-transform duration-300" />
                  </div>
      ...
      <section id="why-us" className="py-14 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-12">
            {[
          ...
          <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <StaggerItem key={title}>
                <div className="group bg-secondary rounded-2xl p-6 hover:bg-foreground transition-colors duration-300">
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-8">
                <div className="max-w-sm">
                  ...
                  <div className="flex items-center gap-4 mt-5">
                    ...
                    <a href="https://www.instagram.com/teamconsol/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-foreground transition-colors">
                    ...
                    <a href="https://www.linkedin.com/in/teamconsol/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-foreground transition-colors">
